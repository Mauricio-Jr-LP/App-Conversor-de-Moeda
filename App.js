...
export default function App() {
  ...
  useEffect(()=>{
    async function loadMoedas(){
      ...
      console.log('Moedas: ' + JSON.stringify(arrayMoedas))
  ...
  async function converter(){
    ...
    console.log('Moeda Selecionada: ' + JSON.stringify(moedaSelecionada));
    const response = await api.get(`all/${moedaSelecionada}-BRL`);
    console.log('Response: '+response.data[moedaSelecionada].ask);
